...
phb_data_path <- '/Users/chrissoria/Documents/Research/BICS_Political_Polarization/data/Partisanship and Health Behavior/Data'
```
...
```{r covid_setup}
usafacts_deaths <- read_csv(paste0(phb_data_path, '/covid_deaths_usafacts.csv'), col_types = cols(
...
```
```{r}
census_pop <- read_csv(paste0(phb_data_path, '/co-est2021-alldata.csv'),
                       col_types = cols(
                         STATE = col_character(),
...
census_pop_FIPS <- read_excel(paste0(phb_data_path, '/all-geocodes-v2020.xlsx'), col_types = c("text"))
...
write_csv(State_FIPS_Crosswalk, paste0(phb_data_path, '/STATE_FIPS_CROSSWALK.csv'))
...
# Read the CSV file
RUC_county_df <- read_csv(paste0(phb_data_path, '/ruralurbancodes2013.csv'), col_types = col_types)
...
State_Restrictions_df <- read_csv(
  paste0(phb_data_path, '/OxCGRT_USA_differentiated_withnotes_2020.csv'),
...
county_pres <- read_csv(paste0(phb_data_path, '/countypres_2000-2020.csv'), col_types = col_types)
...
```{r}
county_CD_share <- read_excel(paste0(phb_data_path, '/federalelections2020.xlsx'),
...
```{r}
if (file_type == "manual") {
  df_merged <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/df_all_waves.rds')
  df_w0 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/pooled_wave0_unweighted.rds')
  df_w1 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave1_unweighted.rds')
  df_w2 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave2_unweighted.rds')
  df_w3 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave3_unweighted.rds')
  df_w4 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave4_unweighted.rds')
  df_w5 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave5_unweighted.rds')
  df_w6 <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_wave6_unweighted.rds')
  ...
  df <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/df_all_waves.rds')
...
if (file_type == "manual") {
  ...
  df_w1_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave1_unweighted.rds')
  df_w1_nonhhalters <- df_w1_nonhhalters %>% 
    select(rid, protection_1, protection_2, protection_3, protection_4)
  
  df_w2_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave2_unweighted.rds')
  df_w2_nonhhalters <- df_w2_nonhhalters %>% 
    select(rid, protection_1, protection_2, protection_3, protection_4)
  
  df_w3_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave3_unweighted.rds')
  df_w3_nonhhalters <- df_w3_nonhhalters %>% 
    select(rid, protection_1, protection_2, protection_3, protection_4)
  
  df_w4_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave4_unweighted.rds')
  df_w4_nonhhalters <- df_w4_nonhhalters %>% 
    select(rid, protection_1, protection_2, protection_3, protection_4)
  
  df_w5_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave5_unweighted.rds')
  df_w5_nonhhalters <- df_w5_nonhhalters %>% 
    select(rid, protection_1, protection_2, protection_3, protection_4)
  
  df_w6_nonhhalters <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/national_alters_nonhh_wave6_unweighted.rds')
  ...
  df_alters_combined <- readRDS('/Users/chrissoria/library/CloudStorage/Box-Box/_bics/bics-data/data/lucid-pipeline/df_alters_all_waves.rds')
}
```
...
bics_zip_features <- bics_zip_features %>%
  mutate(
    In_Opposing_Party_CD = as.integer(
      !is.na(CONGRESSPERSON_PARTY) &
...
bics_zip_features <- bics_zip_features %>%
  mutate(
    ...
    # Use ifelse to preserve NAs: NA %in% c(...) returns FALSE in R, not NA,
    # so as.integer() alone would silently recode non-respondents as 0.
    definitely_get_vax    = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax == "Definitely get a vaccine")),
    probably_get_vax      = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax == "Probably get a vaccine")),
    probably_not_get_vax  = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax == "Probably NOT get a vaccine")),
    definitely_not_get_vax = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax == "Definitely NOT get a vaccine")),

    # Grouped categories
    will_get_vax     = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax %in% c("Definitely get a vaccine", "Probably get a vaccine"))),
    will_not_get_vax = ifelse(is.na(covid19_whynot_vax), NA_integer_, as.integer(covid19_whynot_vax %in% c("Probably NOT get a vaccine", "Definitely NOT get a vaccine")))
  )
